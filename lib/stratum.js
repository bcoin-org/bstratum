...
const crypto = require('bcoin/lib/crypto/crypto');
...
StratumOptions.prototype.fromOptions = function fromOptions(options) {
  ...
  if (options.password != null) {
    ...
    this.password = crypto.hash256(Buffer.from(options.password, 'utf8'));
  }
