...
Stratum.prototype._open = co(function* _open() {
  if (this.node.miner.addresses.length === 0)
    throw Error('No addresses available for coinbase.');
...
Connection.prototype.retarget = function retarget(max) {
  var now = util.ms();
  var pm = Stratum.SHARES_PER_MINUTE;
  ...
  if (this.submissions % pm === 0) {
    target = (this.submissions / pm) * 60000;
